...
@section('container')
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                ...
                                <button class="btn btn-success btn-sm me-2" data-bs-toggle="modal"
                                    data-bs-target="#modal_tambah_tugas">
                                        ...
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $filePath = asset(
                                                            'storage/img_tugas/' . basename($item->upload_tugas),
                                                        );
                                                    ...
                                                    @if (in_array(strtolower($fileExtension), ['jpg', 'jpeg', 'png', 'gif']))
                                                        <a href="#" data-bs-toggle="modal"
                                                            ...
                                                            <img src="{{ $filePath }}" alt="tugas Image" width="30%">
                                                        </a>
                                                    @else
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="modalLabel">Gambar tugas</h5>
                                                                <button type="button" class="btn-close"
                                                                    data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body text-center">
                                                                <img src="{{ $filePath }}" alt="tugas Image"
                                                ...
                                                <td>
                                                    <button class="btn btn-sm btn-primary" title="Edit"
                                                        ...
                                                        data-bs-target="#modal_edit_tugas_{{ $item->id }}">
                                                    ...
                                                    <button class="btn btn-sm btn-success" title="View"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#modal_view_tugas_{{ $item->id }}">
                                                        <i class="fa fa-eye"></i>
                                                    </button>
                                                </td>
                                            </tr>
                                            <div class="modal fade" id="modal_view_tugas_{{ $item->id }}" tabindex="-1"
                                                aria-labelledby="modal_view_tugasLabel_{{ $item->id }}"
                                                aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"
                                                                id="modal_view_tugasLabel_{{ $item->id }}">
                                                                Detail tugas {{ $item->name }}
                                                            </h5>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6 mb-3">
                                                                    <label for="judul_tugas"
                                                                        class="form-label d-flex align-items-center">
                                                                        <i class="fas fa-user me-2"></i> Judul tugas
                                                                    </label>
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-primary">
                                                                <a href="{{ $filePath }}"
                                                                    download="{{ basename($item->upload_tugas) }}"
    ...
    <div class="modal fade" id="modal_tambah_tugas" tabindex="-1" aria-labelledby="modal_tambah_tugasLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal_tambah_tugasLabel">Tambah tugas</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="judul_tugas" class="form-label">
                                <i class="fas fa-chalkboard-teacher"></i> Judul tugas
                            </label>
                            <input type="text" placeholder="Masukkan judul tugas"
                                class="form-control @error('judul_tugas') is-invalid @enderror" name="judul_tugas"
                                id="judul_tugas" value="{{ old('judul_tugas') }}" required>
                            @error('judul_tugas')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            <label for="upload_tugas" class="form-label">
                                <i class="fas fa-upload"></i> Upload tugas
                            </label>
                            <input type="file" class="form-control @error('upload_tugas') is-invalid @enderror"
                                name="upload_tugas" id="upload_tugas" required>
                            @error('upload_tugas')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
    ...
    <script>
        ...
        @if (session('datatidaknemu'))
            Swal.fire({
                icon: 'error',
                title: 'Error',
                text: 'tugas tidak ditemukan, coba lagi',
                confirmButtonText: 'Ok',
            });
        @endif
        document.addEventListener('DOMContentLoaded', () => {
            document.querySelectorAll('.btn-danger').forEach(button => {
                button.addEventListener('click', function() {
                    const tugas = this.closest('tr').querySelector('td:nth-child(3)')
                        .innerText;
                    Swal.fire({
                        title: "Peringatan",
                        text: `Apakah anda ingin menghapus tugas "${tugas}"?`,
                        icon: 'warning',
                        ...
                        if (result.isConfirmed) {
                            window.location.href =
                                `/hapus_tugas/${encodeURIComponent(tugas)}`;
                        }
                    });
                });
            });
