    ...
    <div id="app">
                ...
                <div class="header-content">
                    ...
                    <div class="dropdown dropdown-menu-end">
                        <a href="" class="user-dropdown" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <img class="img-user" src="../assets/images/avatar2.png" alt="user">
                        </a>
        ...
        <nav class="main-sidebar ps-menu">
            ...
            <div class="sidebar-content">
                <ul>
                    <li class="active">
                        <a href="/dashboard_guru" class="link">
                            <i class="ti-home"></i>
                            <span>Dashboard</span>
                        </a>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu ">
                            <li><a href="materi" class="link"><span>Materi</span></a></li>
                            <li><a href="tugas" class="link"><span>Tugas</span></a></li>
                            <li><a href="jawaban_tugas" class="link"><span>Jawaban</span></a></li>
                            <li><a href="laporan" class="link"><span>Laporan</span></a></li>
                        </ul>
                    </li>
                    <li class="menu-category">
